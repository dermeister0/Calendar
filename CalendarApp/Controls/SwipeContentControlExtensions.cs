...
{
    public static class SwipeContentControlExtensions
    {
        #region Animation
        ...
        public static void Show(this UIElement element, int duration, Action<UIElement> callback)
        {
            ...
            SetOpacity(element, duration, 1.0d, (e) =>
            {
                if (callback != null)
                {
                    callback(e);
        ...
        {
            SetOpacity(element, duration, 0.0d, (e) =>
            {
        ...
        {
            Animate(element, "Opacity", duration, opacity, callback);
        }
        ...
        {
            Animate(element, property, duration, value, null);
        }
